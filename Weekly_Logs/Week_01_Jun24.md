...
* **Term 3: The Perpendicular Volume ($-\frac{d-n}{2}\log(2\pi\sigma^{2})$)**
  This acts as the normalisation factor for the Gaussian noise. The quantity $d-n$ represents the number of ambient dimensions that are strictly perpendicular to the manifold. This term accounts for the volume of the noise dispersed out into those off-manifold directions.
